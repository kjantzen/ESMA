...
W = 450; H = 300;
L = (p.screenwidth - W)/2; B = (p.screenheight - H)/2;
h.figure = uifigure(...
    'Position', [L,B,W,H],...
    'Color', p.backcolor,...
...
command_str = [stats.test, '( GND, ''bins'', cond_order, ''factor_names'', factors, ''factor_levels'', clevels,' ch_hood];
...
%**************************************************************************
function callback_assignconditions(hObject, event, h)
